(function() {
  CPUBarChart = function CPUBarChart(target, options) {
    ...
    this.addSubComponents = options.addSubComponents || false;
    this.subComponentDivPrefix = options.subComponentDivPrefix || "cpu";
    this.subComponentTargetContainer = options.subComponentTargetContainer || "cpu_timers";
    // Sub components
    this.subComponents = [];
    // Call parent class
