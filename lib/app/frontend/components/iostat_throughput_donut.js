(function() {
  IOStatThroughputDonut = function IOStatThroughputDonut(target, options) {
    DonutBase.call(this);
    ...
    var self = this;
    this.target = target;
    this.divTarget = this.target + "_text";
  ...
  IOStatThroughputDonut.prototype.data = function(object) {
    var self = this;
    var _data;
