...
ApplicationServer.prototype.start = function start(callback) {
  ...
  // // Set up hardcoded files
  // this.app.get('/css/bootstrap-responsive.css', function(req, res) {
  //   res.end(fs.readFileSync("./public/css/bootstrap-responsive.css"))
  // });

  // this.app.get('/js/bootstrap/jquery.js', function(req, res) {
  //   res.end(fs.readFileSync("./public/js/bootstrap/jquery.js"))
  // });

  // this.app.get('/js/bootstrap/bootstrap.js', function(req, res) {
  //   res.end(fs.readFileSync("./public/js/bootstrap/bootstrap.js"))
  // });

  // this.app.get('/css/bootstrap.css', function(req, res) {
  //   res.end(fs.readFileSync("./public/css/bootstrap.css"))
  // });
